 ...
 */
declare type ProduceRequest = ProduceOptions & {
    /**
...
declare type TopicPartition = {
    topic: string;
    partition: number;
};
declare type TopicPartitionOffset = TopicPartition & {
    offset: number;
};
...
declare type BaseConsumerRequest = {
    /**
...
declare type ConsumeRequest = BaseConsumerRequest & {
    topics: string[];
    /**
...
declare type TopicPartitionOffsetsRequest = {
    /**
 ...
 */
declare type GetTopicsResponse = {
    [topic: string]: number;
};
declare type TopicAssignments = {
    topic: string;
    partitions: number[];
};
declare type InstanceAssignments = {
    name: string;
    topics: TopicAssignments[];
};
declare type GroupAssignments = {
    name: string;
